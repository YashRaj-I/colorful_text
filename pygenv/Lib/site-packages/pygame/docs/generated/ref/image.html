...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.image &#8212; pygame-ce v2.5.4 documentation</title>
...
<div class="line"><span class="signature">get_sdl_image_version(linked=True) -&gt; Optional[tuple[int, int, int]]</span></div>
</div>
